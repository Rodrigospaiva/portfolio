...
function adicionaAoTotal(valor){
    ...
    var elementoTotalformatado = elementoTotal.textContent; //add
    elementoTotalformatado = elementoTotalformatado.toFixed(2) //add
    
}

let link_alteracao_texto = document.getElementById("#alterar");

link_alteracao_texto.addEventListener("click", alterar_texto());
